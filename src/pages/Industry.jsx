  ...
  return (
    <div>
      ...
      <main>
          ...
          <div className="relative w-[90%] mx-auto">
            <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
              ...
              <p className="mt-6 text-lg tracking-tight ">
                Explore how our AI-powered solutions can benefit the Life
                Sciences industry.
              </p>
            </div>
                  ...
                  <div className="group relative rounded-full px-4 py-1 md:rounded-md lg:p-6">
                    <a className="active cursor-pointer">
                      ...
                      <p className="mt-2 hidden text-sm lg:block text-black group-hover:text-black">
                        ...
                        capabilities, dictating the need for advanced,
                        integrated, and secure IT solutions to drive the
                        industry forward. Financial institutions must have:
                      </p>
                    </a>
                  </div>
                ...
                <div id="Introduction" className=" text-justify">
                  <div className="relative ">
                    ...
                    <p className="relative text-base ">
                      ...
                      even the slightest error can have far-reaching
                      consequences.
                    </p>
                    <p className="relative text-base ">
                      Currently, the BFSI sector grapples with data systems that
                      are often compartmentalized, each tailored for specific
                      functions such as customer accounts management,
                      transaction processing, or compliance reporting. This
                      fragmentation leads to data silos, creating challenges in
                      achieving a unified view of customer information and
                      financial records.
                    </p>
                    <p className="relative text-base ">
                      To bridge these disparate systems, many institutions rely
                      on complex integrative frameworks, often underpinned by
                    ...
                    <ul className="mt-4 list-disc list-outside pl-4 space-y-5">
                      ...
                      <li>
                        <p>
                          ...
                          integration of emerging technologies to stay
                          competitive in the fintech arena.
                        </p>
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul className="mt-4 list-disc list-outside pl-4 space-y-5">
                      <li>
                        <p>
                          ...
                          Disparate systems lead to siloed data, complicating
                          the unified analysis and application of information
                      ...
                      <li>
                        <p>
                          ...
                          cyberattacks, demanding ever-more sophisticated
                          security measures.
                        </p>
                      </li>
                      <li>
                      ...
                      <li>
                        <p>
                          ...
                          translating data into actionable insights and
        ...
        <section
          id="features"
          className="relative bg-white pb-28 pt-20 sm:py-32"
        >
          <div className="relative ">
                  ...
                  <div className=" p-12 flex items-center justify-center  lg:order-2 text-white ">
                    <div className=" lg:w-[80%]">
                      ...
                      <p className=" mt-4 text-lg tracking-tight">
                        ...
                        spreadsheets, users can simply use intuitive prompts
                        like 'give me top 5 customer names with the highest
                        number of contracts.' This simplifies the data
                        extraction process and ensures that even those without
                        technical expertise can fetch the necessary information.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className=" p-12 flex items-center justify-center  lg:order-1  ">
                    <div className=" lg:w-[80%]">
                      ...
                      <p className=" mt-4 text-lg tracking-tight">
                        ...
                        monitoring of contracts, sales, and customer
                        interactions. Quills provides an avenue for instant data
                        retrieval, ensuring that businesses can react promptly
                  ...
                  <div className=" p-12 flex items-center justify-center  lg:order-2 text-white ">
                    <div className=" lg:w-[80%]">
                      ...
                      <p className=" mt-4 text-lg tracking-tight">
                        ...
                        preferences. This ensures that reports, presentations,
                        or dashboards are tailored to the specific needs of the
                  ...
                  <div className=" p-12 flex items-center justify-center  lg:order-1  ">
                    <div className=" lg:w-[80%]">
                      ...
                      <p className=" mt-4 text-lg tracking-tight">
                        ...
                        constantly seeking ways to engage with their clients
                        more effectively. Quills can be integrated into web and
                        mobile channels, allowing clients to fetch specific data
                  ...
                  <div className=" p-12 flex items-center justify-center">
                    <div className="lg:w-[80%]">
                      ...
                      <p className="mt-4 text-lg tracking-tight">
                        ...
                        platform. Our AI-powered solutions are at the forefront
                        of innovation, offering you the latest advancements in
                        data analysis.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className=" p-12 flex items-center justify-center">
                    <div className="lg:w-[80%]">
                      ...
                      <p className="mt-4 text-lg tracking-tight">
                        ...
                        requirements. We understand that one size doesn't fit
                        all, so we offer customizable solutions that adapt to
                        your specific needs.
                      </p>
                    </div>
                  </div>
