...
function VisualData() {
  ...
  return (
    <div>
            ...
            <div className=" space-y-[24px]  ">
              ...
              <div className="flex w-full flex-col space-y-4 justify-between items-center ">
                ...
                <h6 className="  text-[#012447] md:text-[16px]  mx-auto font-[300] leading-[160%] text-[18px] md:w-[85%] ">
                  ...
                  set of visualizations. Whether it’s as a table, a chart, or a
                  ...
                  <div className=" text-center space-y-3 ">
                    <div className=" space-y-[20px]">
                      ...
                      <p className=" text-[#757575] md:text-[18px] tracking-wider  w-full mx-auto font-[300] md:leading-[135%] text-[20px] leading-[135%] ">
                        ...
                        popular tools and services, making your chatbot even
                  ...
                  <div className=" py-[150px]  lg:w-[75%] w-[85%] mx-auto">
                    ...
                    <div className=" flex flex-col mt-[100px] lg:w-[70%] w-full mx-auto gap-4 ">
                      ...
                      <Accordion
                        ...
                        answer="Getting started with Quills.ai is easy! Simply sign up for an account, choose a pricing plan, and start using our chatbot to simplify your data workflows."
                      />
                      <Accordion
                        title="Is Quills.ai compatible with my data storage systems?"
                        answer="Yes, Quills.ai seamlessly integrates with various databases, including SQL, NoSQL, and cloud-based storage. It's designed to work with a wide range of data systems."
                      />
                      <Accordion
      ...
      <div className=" w-full  bg-[#ffd000]">
        <div className=" w-[90%] mx-auto text-center py-[120px] space-y-[30px]">
          <h1 className="md:text-[50px] text-[30px] md:leading-[70px] leading-[40px] font-medium lg:w-[70%] mx-auto">
            Ready to Supercharge Your Data Workflow?
          </h1>
          <p>
            Join thousands of satisfied customers who have transformed the way
            they work with data.
          </p>
          <div className="flex items-center justify-center gap-4">
            <DemoButton type="secondary" />
